# 3D coupled THM CO2 - 200x200x100 conservative screening version.
# Base: co2_thm_example_3d_v10_lu_turbo_fast_distributed_pointinj_bjacobi_200x200x100.i
# Changes: keep the 200x200x100 THM + point-injection structure, but use the
...
[Mesh]
  ...
  [well_block]
    ...
    block_id = 10
    block_name = wellbore
    bottom_left = '999.0 999.0 -840.0'
    top_right   = '1001.0 1001.0 -838.4'
    show_info = true
  []
[]
